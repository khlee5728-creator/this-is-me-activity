...
export const transformImage = async (
  ...
  const stylePrompts = {
    cartoon: 'Transform this image into a vibrant cartoon style suitable for children, maintaining the person\'s facial features',
    fairytale: 'Transform this image into a beautiful fairy tale illustration style, maintaining the person\'s facial features',
    superhero: 'Transform this image into a superhero comic book style, maintaining the person\'s facial features',
    lego: 'Transform this image into a LEGO brick minifigure style, maintaining the person\'s facial features',
    fantasy: 'Transform this image into a fantasy art style, maintaining the person\'s facial features',
  }
